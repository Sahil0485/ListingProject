...
<div class="page-container-wrap">
    <div class="container-fluid">
        <div class="row">
            <?php
            $activeListingQuery = $conn->query("SELECT * FROM `listings` WHERE `email` = '$user_email' AND `status` = 'waiting' ORDER BY `listtype` DESC");
...
<div class="listing-modal-content-section">
    <?php
    $activeListingQueryModal = $conn->query("SELECT * FROM `listings` WHERE `email` = '$user_email' AND `status` = 'waiting' ORDER BY `listtype` DESC");
