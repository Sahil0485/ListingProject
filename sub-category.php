...
<?php
$pages = $_GET['pages'];
$pageQuery = $conn->query("SELECT * FROM `addcategory` WHERE `pages` = '$pages'");
...
<div class="popular-listing-section">
    <div class="container">
        <div class="row">
            <?php
            $listingQuery = $conn->query("SELECT * FROM `listings` WHERE `status` = 'Active' AND `link` = '$pages'");
...
<div class="listing-modal-content-section">
    <div class="container">
        <?php
        $listingQueryModal = $conn->query("SELECT * FROM `listings` WHERE `link` = '$pages' AND `status` = 'Active' ORDER BY `listtype` DESC");
