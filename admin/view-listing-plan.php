...
<?php
$pageTitle = "View Listing Plan";
$tableName = "listingplan";
$actionPage = "action-listing-plan.php";
$viewPage = "view-listing-plan.php";
?>
<div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a href="<?= $actionPage ?>" style="float: right; margin-top: 0;"
                        class="btn btn-raised btn-default btn-rounded">Add Plan</a>
                </div>
                <div class="panel-body">
                    <div class="basic-datatable-block">
                        <table id="basic_datatable" class="display table table-bordered basic-data-table">
                            ...
                            <tbody>
                                <?php
                                $viewQuery = $conn->query("SELECT * FROM $tableName ORDER BY `id` ASC");
                                $i = 0;
                                while ($viewRow = $viewQuery->fetch_assoc()) {
                                    ...
                                    <tr>
                                        <td><?php echo $i ?></td>
                                        <td><?php echo $viewRow['listingplan'] ?></td>
                                        <td><?php echo $viewRow['price'] ?></td>
                                        <td><?php echo $viewRow['numberlisting'] ?></td>
                                        <td><?php echo $viewRow['periodtype'] ?></td>
                                        <td><?php echo $viewRow['typelisting'] ?></td>
                                        <td><?php echo $viewRow['website'] ?></td>
