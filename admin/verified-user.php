                ...
                <div class="panel-body">
                    <div class="basic-datatable-block">
                        <table id="basic_datatable" class="display table table-bordered basic-data-table">
                            ...
                            <tbody>
                                <?php
                                $viewQuery = $conn->query("SELECT * FROM $tableName ORDER BY `firstname`");
                                while ($viewRow = $viewQuery->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $cqmail = $viewRow['email'];
                                            $countQuery = $conn->query("SELECT * FROM `listings` where `email` = '$cqmail'");
                                        ...
                                        <td>
                                            <?php
                                            $countQuery2 = $conn->query("SELECT * FROM `listings` where `email` = '" . $viewRow['email'] . "' and status='Active'");
                                            $countRow2 = $countQuery2->num_rows;
                                            echo $countRow2;
                                            ?>
                                        </td>
