...
<?php
$pageTitle = "View Promotions";
$tableName = "promotion";
$actionPage = "action-promotion.php";
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a href="<?= $actionPage ?>" style="float: right; margin-top: 0;"
                        class="btn btn-raised btn-default btn-rounded">Add Promotion</a>
                </div>
                            ...
                            <tbody>
                                ...
                                while ($viewRow = $viewQuery->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $viewRow['sdate'] ?></td>
                                        <td><?php echo $viewRow['edate'] ?></td>
                                        <td><?php echo $viewRow['brand'] ?></td>
                                        <td><?php echo $viewRow['bemail'] ?></td>
