...
<div class="row">
    <div class="page-title-block">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= $viewPage ?>">View Category</a></li>
...
if (isset($_POST['submit'])) {
    ...
    if ($_GET['edit']) {
        if ($path == null) {
            $Query = $conn->query("UPDATE `$tableName` SET `name` = '$name', `pages` = '$pages', `pageorder` = '$pageorder', `status` = '$status', `frontstatus` = '$frontstatus', `date`=Now() WHERE id='$id'");
            if (!$Query) {
            ...
            $Query = $conn->query("UPDATE `$tableName` SET `name` = '$name', `pages` = '$pages', `pageorder` = '$pageorder', `status` = '$status', `frontstatus` = '$frontstatus', `photo` = '$path', `date`=Now() WHERE id='$id'");
        }
    } else {
        if ($path == null) {
            $path = "nophoto.jpg";
        }
        $Query = $conn->query("INSERT INTO `$tableName` (`name`, `pages`, `pageorder`, `status`, `photo`, `frontstatus`) VALUES ('$name', '$pages', '$pageorder', '$status', '$path', '$frontstatus')");
    }
