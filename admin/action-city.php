...
<div class="row">
    <div class="page-title-block">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= $viewPage?>">View City</a></li>
                            ...
                            <form class="form-common" enctype="multipart/form-data" method="post" action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="city" name="city"
                                        value="<?php echo $editRow['city'] ?>" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-common">
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label left-align">Front Display Status</label>
                                        <div class="col-md-8">
...
if (isset($_POST['submit'])) {
    ...
    if ($_GET['edit']) {
        if ($path == null) {
            $Query = $conn->query("UPDATE `$tableName` SET `city` = '$city', `pages` = '$pages', `pageorder` = '$pageorder', `stateid` = '$stateid', `status` = '$status', `frontstatus` = '$frontstatus', `date`=Now() WHERE id='$id'");
            if (!$Query) {
            ...
            $Query = $conn->query("UPDATE `$tableName` SET `city` = '$city', `pages` = '$pages', `pageorder` = '$pageorder', `stateid` = '$stateid', `status` = '$status', `frontstatus` = '$frontstatus', `photo` = '$path', `date`=Now() WHERE id='$id'");
        }
    } else {
        if ($path == null) {
            $path = "nophoto.jpg";
        }
        $Query = $conn->query("INSERT INTO `$tableName` (`city`, `pages`, `pageorder`, `stateid`, `status`, `photo`, `frontstatus`) VALUES ('$city', '$pages', '$pageorder', '$stateid', '$status', '$path', '$frontstatus')");
    }
