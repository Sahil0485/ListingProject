...
$actionPage = "action-category.php";
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a href="<?= $actionPage ?>" style="float: right; margin-top: 0;"
                        class="btn btn-raised btn-default btn-rounded">Add Category</a>
                </div>
                            ...
                            <tbody>
                                ...
                                while ($viewRow = $viewQuery->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $countQuery = $conn->query("SELECT * FROM `listings` where `pages` = '".$viewRow['pages']."' and status='Active'");
