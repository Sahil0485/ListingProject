...
<?php
$statelink = $_GET['statelink'];
$pageQuery = $conn->query("SELECT * FROM `listings` WHERE `statelink` = '$statelink'");
$pageRow = $pageQuery->fetch_assoc();
?>
<div class="subheader">
    <h2><?php echo $pageRow['state'] ?></h2>
...
<div class="breadcrumb-block">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><?php echo $pageRow['state'] ?></li>
        </ol>
    </div>
</div>
</div>
<div class="popular-listing-section">
    <div class="container">
        <div class="row">
            <?php
            $listingQuery = $conn->query("SELECT * FROM `listings` WHERE `status` = 'Active' AND `statelink` = '$statelink'");
                        ...
                        <div class="post-details">
                            <div class="post-meta">
                                <div class="location">
                                    ...
                                    <h5>
                                        <a href="city-listing.php?citylink=<?php echo $listingRow['citylink'] ?>">
                                            <?php echo $listingRow['city'] ?>
                                        </a>
                                    </h5>
                                </div>
                                <div class="tag">
...
<div class="listing-modal-content-section">
    <div class="container">
        <?php
        $listingQueryModal = $conn->query("SELECT * FROM `listings` WHERE `statelink` = '$statelink' AND `status` = 'Active' ORDER BY `listtype` DESC");
                                        ...
                                        <div class="post-details">
                                            <div class="post-meta">
                                                <div class="location">
                                                    ...
                                                    <h5>
                                                        <a
                                                            href="city-listing.php?citylink=<?php echo $listingRow['citylink'] ?>">
                                                            <?php echo $listingRow['city'] ?>
                                                        </a>
                                                    </h5>
                                                </div>
