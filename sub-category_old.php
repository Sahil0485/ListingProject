                        ...
                        <article class="popular-listing-post">
                            <div class="post-thumb">
                                <img src="admin/uploads/listings/<?php echo $listingRow['photo'] ? $listingRow['photo'] : 'nophoto.jpg' ?>"
                                    alt="img" class="img-responsive" width="400px" style="min-height: 200px; max-height: 300px;" height="200px">
                                    ...
                                    <article class="popular-listing-post" style="width:100%;">
                                        <div class="post-thumb">
                                            <?php if ($listingRow['photo']) { ?>
                                                <img src="admin/uploads/listings/<?php echo $listingRow['photo'] ? $listingRow['photo'] : 'nophoto.jpg' ?>"
                                                    alt="img" class="img-responsive" style="width: 100%;min-height: 200px; max-height: 600px;">
                                            <?php } else {
                                                echo '<br><br><br><br>';
                                            } ?>
                                            <div class="listing-info">
